    ...
    <section class="section-home" id="about">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-9">
                    <div class="home-left">
                        <span class="hello mb-2 d-block">Hello,
                            <img alt="wave codeindoug" :src="require('../assets/images/waving-hand.png')" /></span>
                        <!-- <h1 data-text="I’m Douglas Okolaa">I’m Douglas Okolaa</h1> -->
                        <h1>I’m {{ name }}</h1>
                        <p class="my-4">
                            <span class="typed" data-elements="A Fullstack Developer, A Website Manager.,."></span>
                        </p>
                ...
                <div class="col-md-3">
                    <div class="socialShare">
                        <label for="social_button" class="d-none">connect with me</label>
                        <input type="checkbox" id="social_button" />
                        <div class="btn-plus"></div>
                        <div class="tooltip">
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item">
                                    <a href="https://ng.linkedin.com/in/douglas-okolaa" target="_blank">
                                        <FontAwesomeIcon icon="shopping-cart"></FontAwesomeIcon>
                                        <i class="fab fa-linkedin"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="https://twitter.com/douglasokolaa" target="_blank"><i
                                            class="fab fa-twitter"></i></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="https://github.com/douglasokolaa" target="_blank"><i
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
                        ...
                        <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" id="shape-01">
                            <polygon stroke="var(--shape-color-03)"
